...
pub fn debug_draw_box(debug_lines: &mut DebugLines, p: Vec3, size: Vec2, duration: Option<f32>) {
    let duration = duration.unwrap_or(0.0);
    let c0 = Vec3::new(-size.x, size.y, 0.0) * 0.5;
    let c1 = Vec3::new(size.x, size.y, 0.0) * 0.5;
